/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 55ba86cb3f1260c3bbc7a9a6a2866a62)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		routes: [{"pattern":"text.example.com/*","zone_id":"YOUR_ZONE_ID"}];
		RATE_LIMITER: DurableObjectNamespace /* RateLimiter from rate-limiter */;
	}
}
